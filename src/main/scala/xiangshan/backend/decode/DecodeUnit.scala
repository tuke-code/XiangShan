...
//    FDivSqrtDecode.table ++
  ...
  decodedInst.isMove := (isMove || isZimop) && ctrl_flow.instr(RD_MSB, RD_LSB) =/= 0.U && !io.fromCSR.singlestep
  ...
  private val isAmocasQ = false.B //FuType.FuTypeOrR(decodedInst.fuType, FuType.mou) && decodedInst.fuOpType === LSUOpType.amocas_q
