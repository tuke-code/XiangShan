...
trait PMAMethod extends PMAConst {
  ...
  def SimpleMemMapList = List(
      ...
      MemMap("h00_3900_0000", "h00_3900_FFFF",   "h0", "L3CacheCtrl",  "RW"),
      MemMap("h00_3901_0000", "h00_3901_FFFF",   "h0", "UParam",      "RW"),
      MemMap("h00_3902_0000", "h00_3902_FFFF",   "h0", "DSECtrl",     "RW"),
      MemMap("h00_3903_0000", "h00_39FF_FFFF",   "h0", "Reserved",    ""),
