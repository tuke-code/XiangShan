  ...
  val vecSchdParams = {
    ...
    SchdBlockParams(Seq(
      IssueBlockParams(Seq(
        ExeUnitParams(
          "VFEX0",
          Seq(VialuCfg, VfaluCfg, VfmaCfg, VimacCfg, VppuCfg, VipuCfg, VfcvtCfg, VmoveCfg),
      ...
      IssueBlockParams(Seq(
        ExeUnitParams(
          ...
          Seq(VfWB(port = 4, 0), FpWB(port = 7, 0)),
      ...
      IssueBlockParams(Seq(
        ExeUnitParams(
          "VFEX2",
          Seq(VialuCfg, VfmaCfg, VSha256msCfg),
          Seq(VfWB(port = 5, 0)),
      ...
      IssueBlockParams(Seq(
        ExeUnitParams(
          "VFEX3",
          Seq(VialuCfg, VfmaCfg, VSha256cCfg),
          Seq(VfWB(port = 6, 0)),
