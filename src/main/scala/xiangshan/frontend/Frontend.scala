...
class FrontendInlinedImp(outer: FrontendInlined) extends FrontendInlinedImpBase(outer) {
  ...
  ftq.io.toIfu.req.ready := ifu.io.fromFtq.req.ready && icache.io.fromFtq.toMainPipe.ready
  ...
  ftq.io.toICache.toMainPipe.ready := ifu.io.fromFtq.req.ready && icache.io.fromFtq.toMainPipe.ready
