...
class Ifu(implicit p: Parameters) extends IfuModule
  ...
  private val s0_fixedRawInstrVec = Wire(Vec(FetchBlockInstNum, new Instruction))
  s0_fixedRawInstrVec := s0_rawInstrVec
  ...
  private val s0_fixedCompactedInstrVec = Wire(Vec(FetchBlockInstNum, new Instruction))
  s0_fixedCompactedInstrVec := s0_compactedInstrVec
  ...
  private val s0_realInstrVec = Wire(Vec(FetchBlockInstNum, new Instruction))
  s0_realInstrVec := s0_fixedCompactedInstrVec
