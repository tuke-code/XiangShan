...
3. `P0-3` misaligned scalar store
4. `P1-4` nc store flush/drain
5. `P1-5` MMIO store exclusion
6. `P1-1` / `P1-2` replay 精细化
7. `P1-3` load-wait / waitForRobIdx
8. `P2-*` translation / permission
