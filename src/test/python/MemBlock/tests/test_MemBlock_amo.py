...
AMO_POST_RESET_SETTLE_CYCLES = 300
...
def test_api_MemBlock_single_uop_amo_smoke(
    ...
    state = ResetEnvSequence(
        ...
        # give tag-array initialization enough time to complete before issuing the AMO.
        settle_cycles=AMO_POST_RESET_SETTLE_CYCLES,
    ).run(env)
